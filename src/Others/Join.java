...
public class Join implements Listener {
    ...
    public void onJoin(PlayerJoinEvent event) {
        ...
        if(Main.plugin.getConfig().getBoolean("Join.enable")) {
            if (p.hasPermission("wowchat.custom.Join1")) {
            ...
            if (p.hasPermission("wowchat.custom.Join2")) {
            ...
            if (p.hasPermission("wowchat.custom.Join3")) {
            ...
            if (p.hasPermission("wowchat.custom.Join4")) {
            ...
            if (p.hasPermission("wowchat.custom.Join5")) {
